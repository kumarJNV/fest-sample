...
const Addmovie = () => {
  ...
  const AddmovieData = async (e) => {
    ...
    if (response.status === 201) {
      ...
      history('/view-all-movies', { state: { msg: 'Movie Added successfully' } });
    }
    if (response.status != 201) {
      // Handle error
                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <select className="form-control" name="" id="" onChange={(e) => setactcategory(e.target.value)} >
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <input type="text" name="duration" onChange={(e) => setProdcmp(e.target.value)} className="form-control" id="duration" />
