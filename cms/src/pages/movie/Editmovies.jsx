...
export const Editmovies = () => {
  ...
  const [category, setactcategory] = useState();
  const [prodcmp, setProdcmp] = useState('');
  ...
  const fetchCategory = async () => {
    try {
      ...
      setcategoryData(response.data.CategorysList);
      console.log(response.data)
      console.log('test')
  ...
  const fetchData = async () => {
    try {
      ...
      setThumbnail(item.film.thumbnail);
      setBanner(item.film.banner);
      ...
      setProdcmp(item.film.production_company)
      setactcategory(item.film.category)
  ...
  const AddmovieData = async (e) => {
    ...
    formData.append('production_company', prodcmp);
    ...
    try {
      let response = await axios.put(`${BASE_URL}/update-film`, formData, {
        ...
        .then(response => {
          ...
          history('/view-all-movies', { state: { msg: 'Data updated successfully' } });
        })
        .catch(error => {
          console.log(error);
                    ...
                    <div className="row">
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <label for="{{$strFldName}}"><span className="text-danger">*</span>Select Category</label>
                          <select className="form-control" name="" id="" onChange={(e) => setactcategory(e.target.value)} value={category}>
                            <option value="">Select Category</option>
                            {Array.isArray(categoryData) && categoryData.map((value, index) => (
                              <option value={value._id} >{value.cat_name}</option>
                            ))}
                          </select>
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <label for="categories"><span className="text-danger">*</span>Select genre</label>
                      ...
                      <div className="col-xl-6 col-lg-12 col-md-12">
                        <div className="form-group bordergaps posterGaps">
                          <label for="tests">Upload Trailer</label>
                          <div className="">
                            <div className="col-md-12">
                              <FileUpload sendFileData={handletrailerData} optionalData={trailer} />
                            </div>
                      ...
                      <div className="col-xl-6 col-lg-12 col-md-12">
                        <div className="form-group bordergaps posterGaps">
                          ...
                          <div className="">
                            <div className="col-md-12">
                              <FileUpload sendFileData={handleFileData} optionalData={receivedValue} />
                            </div>
                      ...
                      <div className="col-md-6">
                        <div className="form-group">
                          ...
                          <label for="duration">Production Company</label>
                          <input type="text" name="duration" onChange={(e) => setProdcmp(e.target.value)} value={prodcmp} className="form-control" id="duration" />
                          <span className="text-danger">{durationError}</span>
                        </div>
