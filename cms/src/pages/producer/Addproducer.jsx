...
const Addproducer = () => {
    ...
    const producerAdd = async (e) => {
        ...
        let item = { producer_name, social_link, status };
        //console.log(item)
        let response = await fetch(`${BASE_URL}/add-producer`, {
            method: 'POST',
            headers: {
        ...
        if (response.status === 201) {
            ...
            history('/view-all-producers', { state: { msg: 'Actor Added successfully' } });
        }
        if (response.status != 201) {
            // Handle error
                            ...
                            <div className="col-md-12">
                                ...
                                <div className="card card-primary">
                                    ...
                                    <div className="card-body">
                                        <div className="row">
                                            <div className="form-group col-md-6">
                                                ...
                                                <label ><span className="text-danger">*</span>Producer Name</label>
                                                <input type="text" name="producer_name" className="form-control" id="producer_name" maxLength="255" onChange={(e) => setActor(e.target.value)} />
                                    ...
                                    <div className="card-footer col-md-12">
                                        ...
                                        <button className="btn btn-primary" onClick={producerAdd}><i  ></i> Submit</button>
                                    </div>
